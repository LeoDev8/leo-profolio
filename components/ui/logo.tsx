...
export default function Logo({ lang }: { lang: String }) {
  return (
    <div className="w-12 h-12 mx-1">
      <Link
        href={`/${lang}`}
        className="w-full h-full text-2xl font-bold tracking-tight"
      >
        <svg version="1.1" viewBox="0 0 2048 2048" className="w-full h-full">
          <path
          transform="translate(0, 250)"
            d="M 1050, 133
               A 660, 660 0 1, 1 1050, 1453
               A 660, 660 0 1, 1 1050, 133 Z"
            className="fill-logobackground/80"
          />
          <path
