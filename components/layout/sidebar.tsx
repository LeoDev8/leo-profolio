...
export default function Sidebar({
  ...
  return (
    <>
      <div
        className={`fixed inset-0 z-40 bg-foreground/20 backdrop-blur-sm transition-opacity duration-motion ${
      ...
      <aside
        className={`fixed left-0 top-0 z-50 flex h-full w-72 max-w-[82vw] flex-col border-r border-glass-border bg-glass-strong shadow-glass backdrop-blur-md transition-transform duration-motion ease-in-out ${
